...
internal class AsyncRequestResponsePublisher<S : CorrelatedApplicationEvent, R : CorrelatedApplicationEvent>(
    private val applicationEventPublisher: ApplicationEventPublisher,
    private val executorService: ExecutorService,
    private val decisionTimeOutMilliSeconds: Long
) : BlockingPublisher<S, R> {
    companion object {
    ...
    override fun publishAndBlockFor(
        event: S,
