...
internal open class IngressFilter(
    private val messageSource: MessageSource,
    private val publisher: BlockingPublisher<IngressQueryEvent, IngressDecision>,
    ...
    override fun doFilterInternal(
        ...
        val ingressDecision: IngressDecision = publisher
            .publishAndBlockFor(IngressQueryEventData(getOriginHost(request)), IngressDecision::class.java)
